  ...
  <main>
    <div class="m-12 pa-4">
      <v-tabs v-model="tab" align-tabs="center" role="tablist">
        ...
        <v-tab :value="2">My professional experience</v-tab>
        <v-tab :value="3">My Projects</v-tab>
      </v-tabs>

      <v-tabs-window v-model="tab">
        <!-- Who are -->
        <v-tabs-window-item :key="1" :value="1" id="about-me">
          <v-container fluid>
            <AboutMe></AboutMe>
          </v-container>
        </v-tabs-window-item>
        ...
        <!-- Professional -->
        <v-tabs-window-item :key="2" :value="2" id="professional-experience">
          <v-container fluid>
        ...
        <!-- Projects -->
        <v-tabs-window-item :key="3" :value="3" id="my-projects">
          <v-container fluid>
