  ...
  return (
    <div className="flex font-sans justify-between gap-4 h-[500px]">
      <header className="py-15 pl-15 w-[30%] max-h-screen">
        ...
        <div className="text-sm mb-5">Full Stack Developer | Backend Developer | AI Integration</div>
        <div>
        ...
        <a href="https://github.com/AkireL" target="_blank" className="flex flex-column gap-2 items-center">
          <GitHubIcon></GitHubIcon>
        </a>
        <a href="https://www.linkedin.com/in/erika-basurto/" target="_blank">
          <LinkedIn></LinkedIn>
        </a>
        </div>
      </header>
