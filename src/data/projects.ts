export const projects = [
  {
    ...
    img_main: "src/images/portfolio/simulador.png",
    description:
    ...
    results: {
      ...
      images: ["src/images/portfolio/simulador.png"],
    },
    contribution:
  ...
  {
    title: "Touristic",
    img_main: "src/images/portfolio/turistico.png",
    description:
    ...
    results: {
      ...
      images: ["src/images/portfolio/turistico.png"],
    },
    contribution:
  ...
  {
    title: "Billing",
    img_main: "src/images/portfolio/facturacion.png",
    description:
    ...
    results: {
      description: "In the final delivery, all requirements were met.",
      images: ["src/images/portfolio/facturacion.png", "src/images/portfolio/Factura.png"],
    },
    experience: "",
  },
  {
    title: "POS",
    img_main: "src/images/portfolio/TPV.png",
    ...
    results: {
      description: "",
      images: [
        "src/images/portfolio/PagoDeLinea.png",
        "src/images/portfolio/TPVVistaTableroBackOffice.png",
        "src/images/portfolio/GenerarNotificaciones.png",
      ],
    },
    experience:
  ...
  {
    title: "Commissions",
    img_main: "src/images/portfolio/comisiones.png",
    description:
    ...
    results: {
      ...
      images: ["src/images/portfolio/comisiones.png"],
    },
    experience:
  ...
  {
    title: "CRM",
    img_main: "src/images/portfolio/CRM2.png",
    description:
    ...
    results: {
      description: "In the final delivery, all requirements were met.",
      images: ["src/images/portfolio/CRM.png"],
    },
    experience:
  ...
  {
    title: "Questionnarie",
    img_main: "src/images/portfolio/loginQR.jpg",
    description:
    ...
    results: {
      description: "In the final delivery, all requirements were met.",
      images: ["src/images/portfolio/qr.jpg", "src/images/portfolio/loginQR.jpg"],
    },
    experience: "",
  },
  {
    title: "Extranet",
    img_main: "src/images/portfolio/panelnoktos.jpg",
    description:
    ...
    results: {
      description: "In the final delivery, all requirements were met.",
      images: ["src/images/portfolio/panelnoktos.jpg", "src/images/portfolio/login noktos.jpg"],
    },
    experience:
